        ...
        <div className="compare-container">
            ...
            <div className="inline">                  
                <input
                    id="search-first" 
                    type="text" 
                    className={outlineFirst === true ? "search-box-top-error" : "search-box-top"}
                    ...
                    />
                <i 
                    className={closeVisibilityFirst===false ? "close-btn-hidden" : "close-btn-visible"} 
                    onClick={clearInput1}>
                    <Close />
                </i>
            </div>
            ...
            <div className="inline">                  
                <input
                    id="search-second" 
                    type="text" 
                    className={outlineSecond === true ? "search-box-bottom-error" : "search-box-bottom"}
                ...
                />
                <i 
                    className={closeVisibilitySecond===false ? "close-btn-hidden" : "close-btn-visible"} 
                    onClick={clearInput2}>
                    <Close />
                </i>
            </div>
